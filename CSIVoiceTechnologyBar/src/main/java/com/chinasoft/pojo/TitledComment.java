...
public class TitledComment {
    ...
    public TitledComment() {
    }

    public TitledComment(int c_id, String content, String username, Date c_createtime, int a_id, int c_likes, String title) {
        this.c_id = c_id;

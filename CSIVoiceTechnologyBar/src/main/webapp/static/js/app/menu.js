...
function loadMenu(){
	...
	var json='[{"id": "1","name": "贴吧","icon": "","url": "","parentId": "","childs": [{"id": "11","name": "所有文章","icon": "/xingxing.png","url": "http://localhost:8080/CSIVoiceTechnologybyBar/postController/topost?page=1","parentId": "4","childs": []},{"id": "12","name": "我的文章","icon": "/xingxing.png","url": "http://localhost:8080/CSIVoiceTechnologyBar/mypostController/tomypost?page=1","parentId": "4","childs": []},{"id": "14","name": "我的评论","icon": "/xingxing.png","url": "mycomment/show","parentId": "4","childs": []},{"id": "15","name": "语音设置","icon": "/xingxing.png","url": "audio/audioSetGet","parentId": "4","childs": []},{"id": "16","name": "个人设置","icon": "/xingxing.png","url": "jsp/perSetGet","parentId": "4","childs": []},{"id": "17","name": "上传头像","icon": "/xingxing.png","url": "uploadHead.jsp","parentId": "4","childs": []},{"id": "18","name": "用户管理","icon": "/xingxing.png","url": "http://localhost:8080/CSIVoiceTechnologyBar/usermanage/selectAllUser","parentId": "4","childs": []}]}]';
	// jquery的方法
